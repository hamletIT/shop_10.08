        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <section class="panel panel-default">
                    ...
                    <h3 class="panel-title">@if(session()->get('locale') == "en") Add options @else @lang('messages.Add options') @endif</h3> 
                    </div> 
                    <div class="panel-body">
                    
                    <form action="{{ route('option.submit') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                    @csrf
                    ...
                    <!-- <div class="form-group add_fild">
                        <div class="col-sm-offset-3 col-sm-9">
                        <div class="btn btn-primary">@if(session()->get('locale') == "en") Add field @else @lang('messages.Add field') @endif</div>
                        </div>
                    </div> form-group // -->

                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") Name information @else @lang('messages.Name information') @endif</label>
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="information" id="name">
                        </div>
                    </div> <!-- form-group // -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="customFile">@if(session()->get('locale') == "en") option image @else @lang('messages.option image') @endif</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") Products @else @lang('messages.Products') @endif </label>
                        <select name ="product_id" class="form-select form-select-lg">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                        <a class="btn btn-primary" target="_blank" href="https://dstdelivery.sk-its.ru/api/documentation#/Option%20Section/0417cdccfa3da753e8a5f0d0e2db352d">@if(session()->get('locale') == "en") Try in Swagger @else @lang('messages.Try in Swagger') @endif</a>
                        </div>
                    </div> <!-- form-group // -->
