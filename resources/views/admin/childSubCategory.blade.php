            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="panel panel-default">
                        <div class="panel-heading"> 
                            <h3 class="panel-title">@if(session()->get('locale') == "en") Add Child Sub Category @else @lang('messages.Add Child Sub Category') @endif</h3> 
                        </div> 
                        <div class="panel-body">
                            <!-- form-group // -->
                            <form action="{{ route('ChildsubCategory.submit') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="customFile">@if(session()->get('locale') == "en") Child Sub category images @else @lang('messages.Child Sub category images') @endif</label>
                                    <div class="col-sm-9">
                ...
                @if(count($allSubCategory) > 0)
                    <div class="container-fluid">
                        ...
                        <section class="panel panel-default">
                            <div class="panel-heading"> 
                                <h3 class="panel-title">@if(session()->get('locale') == "en") Upadte Child Sub Category @else @lang('messages.Update Child Sub Category') @endif</h3> 
                            </div> 
                            <div class="panel-body">
                                <!-- form-group // -->
                                <form action="{{ route('childSubCategory.update') }}" method="POST" class="form-horizontal" role="form">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") title @else @lang('messages.title') @endif</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") Select the child sub category you want to update @else @lang('messages.Select the child sub category you want to update') @endif </label>
                                        <select name="category_id" class="form-select form-select-lg">
