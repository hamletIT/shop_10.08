            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="panel panel-default">
                        <div class="panel-heading"> 
                            <h3 class="panel-title">@if(session()->get('locale') == "en") Add Sub Category @else @lang('messages.Add Sub Category') @endif</h3> 
                        </div> 
                        <div class="panel-body">
                            <!-- form-group // -->
                            <form action="{{ route('subCategory.submit') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="customFile">@if(session()->get('locale') == "en") Sub category images @else @lang('messages.Sub category images') @endif</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                    <a class="btn btn-primary" target="_blank" href="https://dstdelivery.sk-its.ru/api/documentation#/Sub%20Category%20Section/1d9b90c17470af22232a478403c3e6ca">@if(session()->get('locale') == "en") Try in Swagger @else @lang('messages.Try in Swagger') @endif</a>
                                    </div>
                                </div> 
                            </form>
                            <!-- form-group // -->
                ...
                @if(count($allSubCategory) > 0)
                    <div class="container-fluid">
                        ...
                        <section class="panel panel-default">
                            <div class="panel-heading"> 
                                <h3 class="panel-title">@if(session()->get('locale') == "en") Update Sub Category @else @lang('messages.Update Sub Category') @endif</h3> 
                            </div> 
                            <div class="panel-body">
                                <!-- form-group // -->
                                <form action="{{ route('subCategory.update') }}" method="POST" class="form-horizontal" role="form">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") title @else @lang('messages.title') @endif</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
                                        <a class="btn btn-primary" target="_blank" href="https://dstdelivery.sk-its.ru/api/documentation#/Sub%20Category%20Section/68dd65a0872dfad9b99f290a4f46156d">@if(session()->get('locale') == "en") Try in Swagger @else @lang('messages.Try in Swagger') @endif</a>
                                        </div>
                                    </div> 
                                </form>
                                <!-- form-group // -->
