        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <section class="panel panel-default">
                    ...
                    <h3 class="panel-title">@if(session()->get('locale') == "en") Add store @else @lang('messages.Add store') @endif</h3> 
                    </div> 
                    <div class="panel-body">
                    
                    <form action="{{ route('store.submit') }}" method="POST" class="form-horizontal" role="form">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") Information @else @lang('messages.Information') @endif</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                    <label for="name" class="col-sm-3 control-label">@if(session()->get('locale') == "en") users @else @lang('messages.users') @endif</label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                        <a class="btn btn-primary" target="_blank" href="https://dstdelivery.sk-its.ru/api/documentation#/Store%20Section/0f469761a63d8080fd2b7345f203478b">@if(session()->get('locale') == "en") Try in Swagger @else @lang('messages.Try in Swagger') @endif</a>
                        </div>
                    </div> <!-- form-group // -->
