...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <br>
            <h1 class="h3 mb-2 text-gray-800">Set Rating</h1>
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="{{ route('set.rating.prod') }}" method="POST" class="form-horizontal" role="form">
                                @csrf
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-label">Rating 1 to 5 </label>
                                    <div class="col-sm-9">
                                    <input type="numer" class="form-control" value='' name="rating" id="rating" >
                                    </div>
                                </div> <!-- form-group // -->
